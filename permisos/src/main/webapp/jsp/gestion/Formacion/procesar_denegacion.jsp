...
<head>
    <meta charset="UTF-8">
    <title>Procesar Denegaci�n de Solicitudes</title>
...
<ul id="tabh">
  ...
  <%@ include file="/jsp/gestion/includes/layout_end.jsp" %>
   <table width="85%" border="0" cellspacing="1" cellpadding="2">
    <tr bgcolor="#CCFFCC">
       <td colspan="10" align="center"><b>Procesar Denegaci�n de Solicitudes</b> <input type="hidden" name="TODO_T" ID="TODO_T" size="122" >
      </tr>
     </table>                              
        ...
        if (peticionesSeleccionadas != null && peticionesSeleccionadas.length > 0) {
            ...
            PreparedStatement stmt = null;
                ...
                for (String peticionId : peticionesSeleccionadas) {
                    ...
                    stmt.addBatch();  // A�adimos la actualizaci�n al lote
                }
