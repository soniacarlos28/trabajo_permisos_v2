...
%>
      <%=(((RSPERI_data = RSPERI.getObject("OCUPA"))==null || RSPERI.wasNull())?"":RSPERI_data)%> 
                     ...
                     <table width="95%" border="1" cellspacing="3" cellpadding="4">
							...
							.wasNull()) ? "" : RSQUERY_data)%>','Regenerar todas las incidencias del d�a','regenerar_incidencia.jsp?ID_TODOS=1&ID_INCIDENCIA=')"><img	src="../../imagen/regenerar.jpg" alt="Regenerar Incidencia" width="20" height="20" border="0">							
