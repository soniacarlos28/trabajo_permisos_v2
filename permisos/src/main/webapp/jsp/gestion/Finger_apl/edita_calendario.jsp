                    ...
                    <%  RSCALEN =  (String) (((RSCALENDARIO_HIST_data = RSCALENDARIO_HIST.getObject("ID_CALEN"))==null || RSCALENDARIO_HIST.wasNull())?"":RSCALENDARIO_HIST_data);                            	   
                     if (!RSCALEN.equals(RSCALEN_A ) ) { %>
                           ...
                           <table border=1>
                                  ...
                                  <tr> 
                                        <td width="10%" bgcolor="#FFCCCC" align="center">D�a<span class="va10b"></span></td>
                                        <td width="15%" colspan=2 bgcolor="#FFCCCC" align="center">Obligatorio Ma�ana</td>
                                        <td width="15%" colspan=2 bgcolor="#FFCCCC" align="center">Flexible Ma�ana</td>
