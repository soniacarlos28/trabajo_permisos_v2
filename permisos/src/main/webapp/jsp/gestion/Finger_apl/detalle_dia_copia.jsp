                                ...
                                <tr> 
                                  <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                      ...
                                      <tr>
										...
										<a href="javascript:a�adir();"><img src="../../imagen/new.png" alt="Nuevo"	width="20" height="20" border="0"></a></div> <form name="formFICHA" method=post action="procesa_tran.jsp"> <table width="35%" border="1" cellspacing="1" cellpadding="4">
                                            <tr bgcolor="#FFFFDD"> 
                                              <td bgcolor="#33FFFF">
