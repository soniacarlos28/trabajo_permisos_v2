...
<table width="85%" border="0" cellspacing="1" cellpadding="2">
  <form name="Sindicales" method="POST" action="firmar_select.jsp">
                                     <tr bgcolor="#CCFFCC">
                                         <td colspan="10" align="center"><b>Permisos pendientes de V�B�</b> <input type="hidden" name="TODO_T" ID="TODO_T" size="122" >
                                      ...
                                      <tr bgcolor="#CCCCCC" >
                                        ...
                                        <td colspan="7" align="left"><input type="submit" value="Denegar selecionados" ID="DENI" name="DENI"  onClick="javascript:envia_unavez('0');">                                       
                                         &nbsp;Motivo denegaci�n: &nbsp;<input type="text" name="ID_MOTIVO_DENEGA" ID="ID_MOTIVO_DENEGA" size="55" value="" >
