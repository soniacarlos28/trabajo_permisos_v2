                              ...
                              <td bgcolor="#E0E0E0" valign="top"> 
                                <table border="0" cellspacing="0" cellpadding="2">
                                  <tr> 
                                    ...
                                    <td>                                      
									  <input type="button" value="volver atr�s" name="volver atr�s2" onClick="history.back()" />
                                    </td>
           						...
           						<% } else { %>
									<td width="9%" align="right" nowrap>Grado:</td>
                                     <td colspan="3"><select name="ID_GRADO" disabled="yes" onChange="document.formPermiso.OBSERVACIONES.value=document.formPermiso.GRADO.options[selectedIndex].text">
                                       <option value="4" <%=(("4".toString().equals((((RSPERMISO_data = RSPERMISO.getObject("ID_GRADO"))==null || RSPERMISO.wasNull())?"":RSPERMISO_data)))?"SELECTED":"")%>>Padres/P. Politicos 4 d�as(Enfermedad o Muerte)</option>
                                       <option value="5" <%=(("5".toString().equals((((RSPERMISO_data = RSPERMISO.getObject("ID_GRADO"))==null || RSPERMISO.wasNull())?"":RSPERMISO_data)))?"SELECTED":"")%>>Hijos/H. Politicos Conyuge 5 D�as (Enfermedad o Muerte)</option>
                                       <option value="2" <%=(("2".toString().equals((((RSPERMISO_data = RSPERMISO.getObject("ID_GRADO"))==null || RSPERMISO.wasNull())?"":RSPERMISO_data)))?"SELECTED":"")%>>Abuelos/Hermanos/Nietos 2 D�as(Enfermedad o Muerte)</option>
                                       <option value="1" <%=(("1".toString().equals((((RSPERMISO_data = RSPERMISO.getObject("ID_GRADO"))==null || RSPERMISO.wasNull())?"":RSPERMISO_data)))?"SELECTED":"")%>>Abuelos/Hermanos politicos 1 D�a(Enfermedad)</option>
                                       <option value="2" <%=(("2".toString().equals((((RSPERMISO_data = RSPERMISO.getObject("ID_GRADO"))==null || RSPERMISO.wasNull())?"":RSPERMISO_data)))?"SELECTED":"")%>>Abuelos/Hermanos politicos 2 D�as(Muerte)</option>
                                       <option value="1" <%=(("1".toString().equals((((RSPERMISO_data = RSPERMISO.getObject("ID_GRADO"))==null || RSPERMISO.wasNull())?"":RSPERMISO_data)))?"SELECTED":"")%>>Tios/sobrinos carnales o del conyugue 1 D�a(Enf. o Mue.)</option>
                                    </select></td>
