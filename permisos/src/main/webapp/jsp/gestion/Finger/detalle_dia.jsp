...
PreparedStatement StatementRSFICHAJE_DIA = ConnRSFICHAJE_DIA.prepareStatement("SELECT id_secuencia,       id_funcionario,       pin,       id_dia,       devuelve_min_fto_hora(horas_saldo) as horas_saldo,       horas_saldo-horas_hacer as saldo_diario, devuelve_min_fto_hora(horas_fuera_saldo) as fuera_saldo,       devuelve_min_fto_hora(horas_hacer) as horas_hacer,       festivo,       permiso,       ausencia,       turno1,       turno2,       turno3,       id_calendario,       horas_extras_pagada,       horas_extras_compensada,       audit_usuario,       audit_fecha,       incidencias,       numero_fichajes,       numero_transacciones,       obli_ma�ana_1,       obli_ma�ana_2,       fle_ma�ana_1,       fle_ma�ana_2,       obli_tarde_1,       obli_tarde_2,       fle_tarde_1,       fle_tarde_2,       obli_noche_1,       obli_noche_2,       fle_noche_1,       fle_noche_2,       comida,       libre        FROM fichaje_funcionario_resu_dia  WHERE id_dia =    to_Date('" + RSFICHAJE_DIA__MMColParam2 + "', 'dd/mm/yyyy')   and lpad(id_funcionario, 6, '0') =    lpad('" + RSFICHAJE_DIA__MMColParam1 + "', 6, '0')");
...
%>
                              ...
                              <td colspan=3 width="10%" nowrap class="va12b"  ><div align="center"><strong><strong><%=(((RSSALDO_NEW_data = RSSALDO_NEW.getObject("SALDO"))==null || RSSALDO_NEW.wasNull())?"":RSSALDO_NEW_data)%></strong></strong></div></td>
                                       ...
                                       <tr> 
                                        ...
                                        <td width="30%" colspan=4 bgcolor="#E5E7E9" align="center">Ma�ana</td>
                                      ...
                                      <% if (!RSFICHAJE_DIA_isEmpty ) { %>
                                         <tr> 
                                          <td nowrap width="10%" colspan=2  align="center"> 
                                           <%=(((RSFICHAJE_DIA_data = RSFICHAJE_DIA.getObject("OBLI_MA�ANA_1"))==null || RSFICHAJE_DIA.wasNull())?"":RSFICHAJE_DIA_data)%> - 
                                           <%=(((RSFICHAJE_DIA_data = RSFICHAJE_DIA.getObject("OBLI_MA�ANA_2"))==null || RSFICHAJE_DIA.wasNull())?"":RSFICHAJE_DIA_data)%>
                                     </td>
                                        <td nowrap width="10%" colspan=2  align="center">
                                          <%=(((RSFICHAJE_DIA_data = RSFICHAJE_DIA.getObject("FLE_MA�ANA_1"))==null || RSFICHAJE_DIA.wasNull())?"":RSFICHAJE_DIA_data)%> - 
                                          <%=(((RSFICHAJE_DIA_data = RSFICHAJE_DIA.getObject("FLE_MA�ANA_2"))==null || RSFICHAJE_DIA.wasNull())?"":RSFICHAJE_DIA_data)%>                              
                                        </td>
                                ...
                                <td width="10%" colspan=1  align="center" nowrap>   
								  ...
								  <tr>
								    ...
								    <tr align="center"> <td colspan="14"><div align="center">
                                          <p><b>Permisos en el d�a</b>:<b> <%= RSFICHAJE_DIA__MMColParam2 %></b></p>
                                          </div></td>
								    </tr>
								    <tr> 
                                         <td width="15%" colspan=1 bgcolor="#E5E7E9" align="center">A�o</td>
                                        ...
                                        <td width="15%" colspan=1 bgcolor="#D7DBDD" align="center">N�mero d�as</td>
                                         <td width="15%" colspan=1 bgcolor="#E5E7E9" align="center">Justificado</td>
                                        
                                      </tr>
                                      
                                      <tr> <td nowrap width="17%"  bgcolor="#FFFFFF" align="center"><%=(((RSPERMISO_DIA_data = RSPERMISO_DIA.getObject("A�O"))==null || RSPERMISO_DIA.wasNull())?"":RSPERMISO_DIA_data)%></td>                                                                                   
								  ...
								  <tr>
								    ...
								    <tr align="center"> <td colspan="14"><div align="center">
                                          <p><b>Incidencias en el d�a</b>:<b> <%= RSFICHAJE_DIA__MMColParam2 %></b></p>
                                          </div></td>
								    </tr>
								    <tr> 
               ...
               <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                      <tr>
                                        <td colspan=2 width="35%" align="right"><div align="right">										
										 <td align="right"><a href="javascript:a�adir();"><img src="../../imagen/new.png" alt="A�adir transacci�n"	width="20" height="20" border="0"></a>
                      ...
                      <% if (!RSAUSE_TOTAL_isEmpty ) { %>
								<tr bgcolor="#EFEFEF"  align="center"> 
                                        <td colspan="4"><div align="center">
                                          <p><b>Ausencias o compensatorios en el d�a</b></p></td>
                                          </tr>
                                          <tr bgcolor="#EFEFEF"> 
